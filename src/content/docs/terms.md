...
Alcove is a personal project built by [IAmInControlll](https://github.com/IAmInControlll), referred to below as "the developer".
...
Your own data stays yours. The shortcuts you add, your layout, your settings, and any backups you export belong to you, and the developer has no access to them. See the [Privacy Policy](../privacy/).
...
- **Wikipedia** - article summaries and previews come from the Wikimedia Foundation API. Article text is made available under the [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) licence, and each preview links back to its source article. Wikipedia content is contributed by volunteers and Alcove makes no claim about its accuracy.
